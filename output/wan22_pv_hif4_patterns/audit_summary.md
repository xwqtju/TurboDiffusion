...
四个 `batch.json` 均报告 `task_count=8`、8 个预期输出，且四组各有 8 个非空 MP4。三组 P@V 的配置分别是 `2to4`、`4to8_pairwise`、`2to4_share2`，均为 `pv_hif4=true`；dense 组为 `pv_sparsity=none`、`pv_hif4=false`。四组 Q/K 稀疏开关均为 false，未启用层回退。
