# Wan2.2 SLA Three-Configuration VBench Results

Protocol: 8 videos per method, 1280x720, 81 frames, 4 steps, seed 0. Mean is the unweighted arithmetic mean of SC/BC/AQ/IQ/OC/MC.

| Method | SC | BC | AQ | IQ | OC | MC | Mean | Delta vs SLA |
|---|---:|---:|---:|---:|---:|---:|---:|---:|
...
Raw per-metric VBench outputs are under `vbench_scores/`.
