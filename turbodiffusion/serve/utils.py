...
LAUNCH_ONLY_PARAMS = [
    ...
    "linear_kv_2to4_operand", "linear_qkv_2to4_operand",
...
def format_config(args: argparse.Namespace, defaults: dict) -> str:
    ...
    lines.append(f"  linear_kv_2to4_operand: {args.linear_kv_2to4_operand}")
    lines.append(f"  linear_qkv_2to4_operand: {args.linear_qkv_2to4_operand}")
